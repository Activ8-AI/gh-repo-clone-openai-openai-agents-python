<!-- managed-by: activ8-context-pack | pack-version: 1.2.0 -->
<!-- source-sha: 706ef6d -->
<!-- purpose: Thin wrapper to bind this repo to the Activ8 AI Charter + central policy -->
<!-- updated: 2026-03-18 -->

# AI Agent Policy — gh-repo-clone-openai-openai-agents-python
...
- **Repo identity:** `gh-repo-clone-openai-openai-agents-python`
